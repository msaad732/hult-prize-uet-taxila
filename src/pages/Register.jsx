            ...
            <div className="max-w-2xl w-full text-center">
                ...
                <div className="mb-12">
                    <div className="inline-flex items-center px-4 py-2 rounded-full bg-hult-magenta/10 border border-hult-magenta/30 mb-6">
                        <span className="text-hult-magenta text-sm font-medium">Registration Open</span>
                    </div>
                ...
                <div className="card p-10 bg-gradient-to-br from-hult-magenta/10 to-transparent border-hult-magenta/30">
                    ...
                    <p className="mt-6 text-sm text-gray-500">
                        Deadline: <span className="text-hult-magenta font-semibold">February 8, 2026</span>
                    </p>
                </div>
                ...
                <div className="mt-12 text-gray-400 text-sm">
                    <p>
                        ...
                        <a href="mailto:hultprizeuett@gmail.com" className="text-hult-magenta hover:underline">
